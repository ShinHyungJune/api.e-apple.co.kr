...
class CodeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('codes')->insert([
            ...
            ['id' => 3, 'parent_id' => 2, 'left_id' => 0, 'right_id' => 0, 'order' => 0, 'name' => '유기농', 'is_use' => true, 'is_display' => true],
            ['id' => 4, 'parent_id' => 2, 'left_id' => 0, 'right_id' => 0, 'order' => 0, 'name' => '제철', 'is_use' => true, 'is_display' => true],
            ['id' => 5, 'parent_id' => 2, 'left_id' => 0, 'right_id' => 0, 'order' => 0, 'name' => '고당도', 'is_use' => true, 'is_display' => true],
            ['id' => 6, 'parent_id' => 1, 'left_id' => 0, 'right_id' => 0, 'order' => 0, 'name' => '수입과일', 'is_use' => true, 'is_display' => true],
            ['id' => 7, 'parent_id' => 6, 'left_id' => 0, 'right_id' => 0, 'order' => 0, 'name' => '열대과일', 'is_use' => true, 'is_display' => true],
